...
export async function assignLabel(orderNumber) {
  ...
  // Un retour existe déjà pour cette commande : on renvoie la même étiquette
  // au lieu d'en consommer une nouvelle. La cliente peut donc redemander son
  // étiquette autant de fois qu'elle veut, sans vider le stock.
