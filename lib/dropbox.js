...
//
// Le code-barres scanné ne contient pas les espaces du CSV, et peut porter
// des caractères de contrôle selon le lecteur : on compare des versions
// normalisées plutôt que les chaînes brutes.
export async function findReturnByTracking(tracking) {
  ...
  const label = labels.find(
    (l) => l.return_id && normalize(l.tracking_number) === target
  );
